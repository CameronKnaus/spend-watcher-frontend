...
export default function RecurringSpendForm({
    editMode,
    ...
    useEffect(() => {
        setForwardActionCallback(() => {
            ...
            if (editMode) {
                return () => {
                    // Handle service call
                    axios
                        .post(SERVICE_ROUTES.editRecurringExpense, {
            ...
            return () => {
                // Handle service call
                axios
                    .post(SERVICE_ROUTES.submitNewRecurringExpense, {
                        spendName: expenseName,
                        amount: Number(amount),
                        spendCategory: category || 'OTHER',
                        isVariable,
        ...
        category,
        editMode,
        existingTransaction.recurringSpendId,
        expenseName,
        isVariable,
        queryClient,
        setForwardActionCallback,
    ...
    return (
        ...
        <div style={{ marginBottom: editMode ? '-5rem' : '' }}>
            ...
            {editMode && (
                <Link
                    text={getContent('PERMANENTLY_DELETE')}
