const locale = {
    ...
    trends: {
        ...
        discretionaryTotalCountHeader: 'Disc. transaction count',
        discretionaryTotalPercentageHeader: 'Disc. % of total',
        discretionaryTotalCountPercentageHeader: 'Disc. % of transactions',
        recurringTotalHeader: 'Recurring total',
        recurringTotalCountHeader: 'Rec. transaction count',
        recurringTotalPercentageHeader: 'Rec. % of total',
        recurringTotalCountPercentageHeader: 'Rec. % of transactions',
        total: 'Total',
    },
    general: {
        empty: '--',
